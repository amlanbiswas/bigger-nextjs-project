...
const MeetupDetails = props => {
  return /*#__PURE__*/Object(jsx_runtime_["jsxs"])(jsx_runtime_["Fragment"], {
    ...
    }), /*#__PURE__*/Object(jsx_runtime_["jsx"])(meetups_MeetupDetail, _objectSpread({}, props.meetupData))]
  });
};

const getStaticPaths = async () => {
  const client = await external_mongodb_["MongoClient"].connect('mongodb+srv://amlan:amlan@cluster0.sguj2iz.mongodb.net/myDB?retryWrites=true&w=majority');
  const db = client.db();
